        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: 40, paddingBottom: 40, borderBottom: `1px solid ${COLORS.border}` }}>
          ...
          <div>
            ...
            {[
              ...
              <button key={l.label} onClick={() => onGoTo?.(l.page)} style={{ display: "block", background: "none", border: "none", color: COLORS.textMuted, fontSize: 13, cursor: "pointer", marginBottom: 10, padding: 0, textAlign: "left", transition: "color 0.2s" }}
